...
<div class="card col-md-6">
    <div class="card-body">
        <form method="post" action="<?= base_url('/admin/data_admin/store') ?>">
            <?= csrf_field() ?>
            ...
            <div class="input-style-1">
                ...
                <input type="text" name="username" placeholder="Username" class="form-control <?= $validation->hasError('username') ? 'is-invalid' : '' ?>" />
                <div class="invalid-feedback">
