...
<div class="row">
    ...
    <div class="col-xl-3 col-lg-4 col-sm-6">
        <div class="icon-card mb-30">
            ...
            <div class="content">
                <h6 class="mb-10">Total Perusahaan</h6>
                <h3 class="text-bold mb-10"><?= $total_perusahaan; ?></h3>
            </div>
        </div>
    </div>
    <!-- End Col -->
    <div class="col-xl-3 col-lg-4 col-sm-6">
        <div class="icon-card mb-30">
            ...
            <div class="content">
                <h6 class="mb-10">Total Purchasing</h6>
                <h3 class="text-bold mb-10"><?= $total_purchasing; ?></h3>
            </div>
        </div>
    </div>
    <!-- End Col -->
